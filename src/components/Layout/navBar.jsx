          ...
          <div className={`lg:flex flex-1 items-center justify-between ml-8 ${isOpen ? 'absolute top-20 left-0 right-0 bg-white p-4 border-b shadow-lg' : 'hidden'} lg:relative lg:top-0 lg:bg-transparent lg:border-none lg:shadow-none`}>
            ...
            <div className="flex flex-col lg:flex-row items-center space-y-4 lg:space-y-0 lg:space-x-6">
              ...
              <div className="flex flex-col lg:flex-row space-y-2 lg:space-y-0 lg:space-x-2">
                <a href="#"><button className="px-6 py-2 rounded-full border border-gray-800 hover:bg-gray-100">
                  Login
                </button></a>
                
                <a href="#">
                <button 
                className="px-6 py-2 rounded-full bg-gray-800 text-white hover:bg-gray-700" id='Sign-Up'>
                  Sign Up
                </button></a>
              </div>
            </div>
