...
<div class="profile-view" id="profile-view">
     ...
     <a href="http://localhost:5173/"><button class="logout-btn" id="logout-btn"><h3 class="logout-btn-text">Logout</h3>&nbsp;&nbsp;&nbsp;
     <img src="icon/logout.png" class="logout-img" id="logout-img" alt="logout"></button></a>
